...
int main(int argc, char *argv[])
{
    ...
    // d) b.method_2("string"); // a) Fehlermeldung weil a.method_2(double) die Methode verdeckt b) Ausgabe: b.method_2(\"string\")
    cout << "a.method_3(1) ";
    ...
    cout << "b.method_3('c') ";
    b.method_3('c'); // a) keine Fehlermeldung;	b) Ausgabe: b.method_3('c'): B::(int)
...
// Aufgabe c)
// Methode              | überlädt, verdeckt oder redefiniert. | Methode
//-------------------------------------------------------------------
// B::method_3(string)  | überlädt				   			  | B::method_3(int)
// B::method_3(string)  | verdeckt				   			  | A::method_3(char)
// B::method_3(string)  | redefiniert				   		  | A::method_3(string)
