...
/*
        ...
        gcc -std=gnu99 -Wall -O2 -o bench_rdtsc bench_rdtsc.c
        ./bench_rdtsc

        gcc -std=gnu99 -Wall -O2 -o bench_signal bench_signal.c
        ./bench_signal

        gcc -std=gnu99 -Wall -O2 -o bench_mmap bench_mmap.c
        ./bench_mmap

        gcc -std=gnu99 -Wall -O2 -o bench_pipe bench_pipe.c
        ./bench_pipe
